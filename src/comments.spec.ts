...
describe('interpret comment tests', () => {
  ...
  it ('rsvps', async () => {
    ...
    expect(classify_comment(blob, [
      'http://mydoma.in/short',
      'http://mydomain.com/my-post'])).toEqual(['reply', 'rsvp']);
  });
  ...
  it ('invites', async () => {
    ...
    expect(classify_comment(blob, [
      'http://mydoma.in/short',
      'http://mydomain.com/my-post'])).toEqual(['reply', 'invite']);
  });
  ...
  it ('likes', async () => {
    ...
    expect(classify_comment(blob, [
      'http://mydoma.in/short',
      'http://mydomain.com/my-post'])).toEqual(['like']);
  });
  ...
  it ('reposts', async () => {
    ...
    expect(classify_comment(blob, [
      'http://mydoma.in/short',
      'http://mydomain.com/my-post'])).toEqual(['repost']);
  });
  ...
  it ('multi reply', async () => {
    ...
    expect(classify_comment(blob, [
      'http://mydomain.com/my-post'])).toEqual(['reply']);
  });
  ...
  it ('multi modal', async () => {
    ...
    const ct = classify_comment(blob, [
      'http://mydoma.in/short',
      'http://mydomain.com/my-post']);
